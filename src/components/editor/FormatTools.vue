<template>
    <div class="format-tools-tooltip animate-popup" v-show="isEditorTools" :style="position">
        ...
        <div v-show="isLinkEditing" class="format-tools-link row">
            <div class="col-xs-8">
...
<script>
    ...
    export default {
        ...
        watch: {
            editor: function (val) {
                val.addEventListener('mouseup', this.handle)
            },
