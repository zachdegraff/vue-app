                    ...
                    <q-tabs no-pane-border color="#f7f7f7" class="col">
                        ...
                        <q-tab-pane name="all">
                            <q-infinite-scroll :handler="loadCPs">
                                <content-packs :filter="false" :name="content-packs" :team="team" :items="contentpacks" :subscriptions="cpsubscriptions"></content-packs>
                            </q-infinite-scroll>
                        </q-tab-pane>
                        <q-tab-pane name="subscribed">
                            <q-infinite-scroll :handler="loadCPs">
                                <content-packs :filter="true" :name="subscribed-content-packs" :team="team" :items="contentpacks" :subscriptions="cpsubscriptions"></content-packs>
                            </q-infinite-scroll>
                        </q-tab-pane>
                    </q-tabs>
                </div>
